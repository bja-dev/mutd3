...
import { type ChartMetricKey, type ChartOrientation, mapTeamStanding, METRIC_OPTIONS, type RawTeamSeasonData, type TeamSeasonData } from "./types";
  ...
  return (
    <main className="app-container">
      ...
      <div id="controls">
        ...
        <select
          value={orientation}
          onChange={(e) => setOrientation(e.target.value as ChartOrientation)}
        >
      ...
      <div id="chart">
        <GenericBarChart data={chartData} orientation={ orientation } />
      </div>
    </main>
  );
}
